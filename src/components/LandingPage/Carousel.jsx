...
const products = [
    ...
    {
        image: "https://firebasestorage.googleapis.com/v0/b/merch-images-0909.firebasestorage.app/o/producto-4-removebg-preview.png?alt=media&token=7ad2547e-0ff9-4a32-9547-73bfa98d6d3d",
    },
    {
        ...
        <div className="w-full mb-60">
            ...
            >
                {products.map((product, index) => (
                    <SwiperSlide key={product.id} className="transition-all duration-300 ease-in-out">
                        {({ isActive }) => (
                            <div className={`
